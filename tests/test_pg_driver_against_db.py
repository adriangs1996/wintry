...
# Models and tables should be created before repository registry
# We do not own a module to import, so we hard-write it here
...
winter.backend.Backend.configure_for_driver(WinterSettings(connection_options=ConnectionOptions(
...
@pytest.mark.asyncio
async def test_repository_can_insert(clean) -> None:
